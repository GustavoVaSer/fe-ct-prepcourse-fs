...
function asAmirror(frase) {
   ...
   // Recorrer el arreglo y para cada palabra, invertir su orden de letras.
   ...
   // Unir las palabras invertidas para formar la frase resultante.
...
function capicua(numero) {
   ...
   // Tu código:
     // Convertimos el número a un string para poder invertirlo
  var strNumero = numero.toString();

  // Invertimos el string
  var strNumeroInvertido = strNumero.split('').reverse().join('');
